---
document_id: 2026-08-06-repository-codex-claude-git-init-plan
owner_project: repository
document_type: implementation_plan
status: completed
created: 2026-08-06
owner: Jin Hyun Kim (PM)
canonical_path: infrastructure/docs/superpowers/plans/2026-08-06-repository-codex-claude-git-init-plan.md
implements: infrastructure/docs/superpowers/specs/2026-08-06-repository-codex-claude-git-init-design.md
supersedes: null
artifact_roots:
  - repository root policy files
verification:
...
- Never stage `resources/data/shared/opendataset/`, `resources/data/shared/song-datasets/`, WSI/array/weight files, environments, caches, generated audit outputs, external model repositories, or paper backups.
...
**Interfaces:**
- Consumes: `infrastructure/docs/superpowers/specs/2026-08-06-repository-codex-claude-git-init-design.md` and the existing audit/morphology designs.
...
- [ ] **Step 2: Create `.gitignore` with explicit data and artifact exclusions**
  ...
  ```gitignore
  resources/data/shared/opendataset/
  resources/data/shared/song-datasets/
  .venv/
  resources/projects/prostate_biomarker_validation/model_workspace/.venv-*/
  **/__pycache__/
  .pytest_cache/
  .mypy_cache/
  .ruff_cache/
...
- [ ] **Step 5: Create a concise `README.md`**
  ...
  .venv/bin/python resources/projects/prostate_biomarker_validation/model_workspace/audit_precise_pni_frozen_scores.py
  ```
...
- [ ] **Step 4: Stage the exact allowlist**
  ...
  PNI관련연구.md
  docs/
  resources/projects/prostate_biomarker_validation/model_workspace/pilot_precise_pni_candidates.py
  resources/projects/prostate_biomarker_validation/model_workspace/build_precise_pni_review_html.py
  resources/projects/prostate_biomarker_validation/model_workspace/audit_precise_pni_frozen_scores.py
  resources/projects/prostate_biomarker_validation/model_workspace/pilot_precise_spatial_facevalidity.py
  tests/test_precise_pni_frozen_score_audit.py
  ```

- [ ] **Step 5: Audit staged names, extensions, and sizes**

  Require that no staged path begins with `resources/data/shared/opendataset/`, `resources/data/shared/song-datasets/`, `.venv/`, `paper_backup`, or a nested model repository. Reject staged `.svs`, TIFF, Zarr, NPY/NPZ, HDF5, weight, cache, PDF, or bytecode files. Report every staged file above 1 MiB and verify it is the explicitly approved `cohort_manifest.csv`; reject any staged file above 5 MiB.

---
document_id: 2026-08-06-repository-codex-claude-git-init-design
owner_project: repository
document_type: design
status: completed
created: 2026-08-06
owner: Jin Hyun Kim (PM)
canonical_path: infrastructure/docs/superpowers/specs/2026-08-06-repository-codex-claude-git-init-design.md
implements: null
supersedes: null
artifact_roots:
...
- `resources/data/shared/opendataset/` and `resources/data/shared/song-datasets/`;
- virtual environments including `.venv/` and `resources/projects/prostate_biomarker_validation/model_workspace/.venv-*`;

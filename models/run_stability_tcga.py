...
SLIDES = ROOT / "opendataset/TCGA-PRAD/slides"
META = ROOT / "models/tcga_prad_conch_cache/meta.csv"
CLINICAL = ROOT / "models/tcga_prad_clinical_extra/prad_pub_sample_clinical.json"
...
def main():
    ...
    out = ROOT / "models/stability_runs" / args.output_tag / args.encoder.lower()

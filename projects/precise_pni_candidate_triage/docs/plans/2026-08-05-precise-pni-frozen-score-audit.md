...
- Treat `resources/data/shared/opendataset/PRECISE/precise_pni_review (1).csv` as immutable and prove byte identity with pre/post SHA256.
...
- Create: `projects/precise_pni_candidate_triage/code/frozen_score_audit/audit_precise_pni_frozen_scores.py`
...
- Modify: `projects/precise_pni_candidate_triage/code/frozen_score_audit/audit_precise_pni_frozen_scores.py`
...
**Files:**
- Modify: `projects/precise_pni_candidate_triage/code/frozen_score_audit/audit_precise_pni_frozen_scores.py`
- Create at runtime: `resources/data/shared/opendataset/PRECISE/pni_frozen_score_audit/normalized_review.csv`
- Create at runtime: `resources/data/shared/opendataset/PRECISE/pni_frozen_score_audit/data_integrity_report.csv`
- Create at runtime: `resources/data/shared/opendataset/PRECISE/pni_frozen_score_audit/candidate_audit_table.csv`
- Create at runtime: `resources/data/shared/opendataset/PRECISE/pni_frozen_score_audit/review_budget_capture.csv`
- Create at runtime: `resources/data/shared/opendataset/PRECISE/pni_frozen_score_audit/score_metric_summary.csv`
- Create at runtime: `resources/data/shared/opendataset/PRECISE/pni_frozen_score_audit/cluster_bootstrap_replicates.csv`
- Create at runtime: `resources/data/shared/opendataset/PRECISE/pni_frozen_score_audit/subtype_and_stratum_summary.csv`
- Create at runtime: `resources/data/shared/opendataset/PRECISE/pni_frozen_score_audit/error_review_table.csv`
- Create at runtime: `resources/data/shared/opendataset/PRECISE/pni_frozen_score_audit/run_config.json`
- Create at runtime: `resources/data/shared/opendataset/PRECISE/pni_frozen_score_audit/RESULTS_REPORT.md`
...
**Files:**
- Regenerate: all files under `resources/data/shared/opendataset/PRECISE/pni_frozen_score_audit/`
...
- [ ] **Step 1: Record the source hash and execute the full audit**
  ...
  Run: `sha256sum 'resources/data/shared/opendataset/PRECISE/precise_pni_review (1).csv' && .venv/bin/python projects/precise_pni_candidate_triage/code/frozen_score_audit/audit_precise_pni_frozen_scores.py`

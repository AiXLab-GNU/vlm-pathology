---
document_id: 2026-08-05-precise-pni-frozen-score-audit-design
owner_project: precise_pni_candidate_triage
document_type: design
status: approved
created: 2026-08-05
owner: Jin Hyun Kim (PM)
canonical_path: projects/precise_pni_candidate_triage/docs/designs/2026-08-05-precise-pni-frozen-score-audit-design.md
implements: null
supersedes: null
artifact_roots:
...
- `resources/data/shared/opendataset/PRECISE/precise_pni_review (1).csv`: final clinician export,
  retained read-only as the source record.
- `resources/data/shared/opendataset/PRECISE/pni_review_120_selection_manifest.csv`: blinded review
  selection manifest and frozen score components.
- `resources/data/shared/opendataset/PRECISE/pni_candidate_full/all_candidate_scores.csv`: all 2,264
  mask-filtered candidate windows from 19 malignant slides.
- `resources/data/shared/opendataset/PRECISE/pni_candidate_full/run_config.json`: frozen CONCH model,
  prompts, exemplar set, geometry, and score weights.
- `resources/data/shared/opendataset/PRECISE/pni_review_120_build_summary.json`: selection seed and
  sampling structure.
...
`projects/precise_pni_candidate_triage/code/candidate_visualization/build_precise_pni_review_html.py`. For each slide, retained candidates
...
`resources/data/shared/opendataset/PRECISE/pni_frozen_score_audit/`

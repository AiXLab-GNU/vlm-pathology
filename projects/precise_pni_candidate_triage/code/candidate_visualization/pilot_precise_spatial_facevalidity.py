...
Run with the CONCH-only venv, on a free GPU:
    CUDA_VISIBLE_DEVICES=<free_gpu> HF_HOME=~/.cache/huggingface-jhkim \
        resources/projects/prostate_biomarker_validation/model_workspace/.venv-conch/bin/python projects/precise_pni_candidate_triage/code/candidate_visualization/pilot_precise_spatial_facevalidity.py
"""
import os
import re
...
PRECISE_DIR = os.path.join(ROOT, "resources/data/shared/opendataset/PRECISE/extracted/data")
PARTICIPANTS_CSV = os.path.join(ROOT, "resources/data/shared/opendataset/PRECISE/participants.csv")
NADT_CACHE = os.path.join(ROOT, "resources/projects/prostate_biomarker_validation/model_workspace/nadt_conch_cache")
OUT_CSV = os.path.join(ROOT, "resources/data/shared/opendataset/PRECISE/spatial_facevalidity_results_150um.csv")

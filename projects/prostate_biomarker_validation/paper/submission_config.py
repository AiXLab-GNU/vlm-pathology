...
from projects.prostate_biomarker_validation.paper.figures.style import DOUBLE_COLUMN_MM
...
SUPPLEMENT_FIGURES = (
    ...
    FigureSpec(
        ...
        (
            "resources/projects/prostate_biomarker_validation/model_workspace/marker7_td_auc_curve.csv",
            "resources/projects/prostate_biomarker_validation/model_workspace/marker7_calibration_3y_5y.csv",
            "paper/figure_data/fig5_marker7_transfer.csv",
        ),
...
TABLES = (
    ...
    TableSpec(
        "S2", "tab:supp-family",
        ("resources/projects/prostate_biomarker_validation/model_workspace/revision_global_fdr_summary.csv",),
        "paper/generate_submission_tables.py",
    ...
    TableSpec(
        ...
        ("resources/projects/prostate_biomarker_validation/model_workspace/stability_summary.csv",),
        "paper/generate_submission_tables.py",

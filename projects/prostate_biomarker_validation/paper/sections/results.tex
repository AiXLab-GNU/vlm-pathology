...
Figure~\ref{fig:evidence-axis-matrix} summarizes the complete study architecture. Grade and
phenotype have the broadest applicable support; PTEN and AR retain evidence gaps despite
positive pooled results; and SPOP and recurrence show the greatest conditionality.
Unevaluated or unresolved cells identify open evidence gaps and are not negative findings.

\clearpage
\begin{figure}[p]
\centering
\includegraphics[width=\textwidth]{figures/fig7_evidence_axis_matrix.pdf}
\caption{\figEvidenceAxisLegend}
\label{fig:evidence-axis-matrix}
\end{figure}
\clearpage

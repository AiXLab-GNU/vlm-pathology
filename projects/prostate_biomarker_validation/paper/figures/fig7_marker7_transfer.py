...
ROOT = HERE.parents[1]
SUMMARY = ROOT / "resources/projects/prostate_biomarker_validation/model_workspace/marker7_survival_common_cohort_summary.csv"
DELTAS = ROOT / "resources/projects/prostate_biomarker_validation/model_workspace/marker7_survival_paired_deltas.csv"
BLUE = "#2a78d6"
ORANGE = "#eb6834"
GRID = "#e1e0d9"

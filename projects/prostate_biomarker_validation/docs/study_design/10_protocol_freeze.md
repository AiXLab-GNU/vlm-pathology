...
- **(2) Qualified pool**: 다음 4개 게이트를 **전부** 통과한 마커만.
  ...
  - 이 규칙을 현재 알려진 정보에 기계적으로 적용하면: **①②는 게이트 1-3을 이미
    ...
    게이트4까지 전부 통과 확정**(2026-07-31, `resources/projects/prostate_biomarker_validation/model_workspace/pilot_confounder_audit.py`:
...
- 2026-08-03(major-revision 재분석): 기존 full-cohort LRT/고정-score permutation보다
  ...
  재계산했다(`resources/projects/prostate_biomarker_validation/model_workspace/revision_global_fdr_summary.csv`). 규칙 자체의 사후 변경은 없다.

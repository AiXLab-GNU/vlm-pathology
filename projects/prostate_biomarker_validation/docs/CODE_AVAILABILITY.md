...
- `projects/prostate_biomarker_validation/code/legacy/build_revision_p0_artifacts.py`: validates and assembles the
  publication-facing revision artifacts.
- `projects/prostate_biomarker_validation/code/legacy/aggregate_stability_grid.py`: reconciles the frozen correlated
  encoder--scale--tile--seed stability grid.
- `projects/prostate_biomarker_validation/code/legacy/build_tcga_cdr_pfi_evidence.py`: audits official TCGA-CDR PFI
  evidence and endpoint mappings.
- `projects/prostate_biomarker_validation/code/legacy/build_marker7_survival_paired_analysis.py`: constructs the paired
  recurrence-endpoint survival analysis.
- `projects/prostate_biomarker_validation/code/legacy/run_marker7_common_source_sensitivity.py`: runs the common-source
  marker 7 sensitivity analysis.
- `projects/prostate_biomarker_validation/code/legacy/build_ar_spop_evidence_closure.py`: assembles the AR site and SPOP
  evidence closure.

...
SCRIPT = ROOT / "resources/projects/prostate_biomarker_validation/model_workspace/build_marker7_survival_paired_analysis.py"
...
class Marker7SurvivalPairedContractTests(unittest.TestCase):
    ...
    def test_official_pfi_inputs_use_namespaced_r3_manifest(self):
        ...
        self.assertEqual(predictions, ROOT / "resources/projects/prostate_biomarker_validation/model_workspace/tcga_cdr_pfi_patient_predictions.csv")
        self.assertEqual(manifest, ROOT / "resources/projects/prostate_biomarker_validation/model_workspace/tcga_cdr_pfi_run_manifest.csv")
    ...
    def test_run_snapshots_exact_inputs_before_reading_any_analytical_csv(self):
        ...
        with tempfile.TemporaryDirectory() as temporary:
            root = Path(temporary)
            models = root / "resources/projects/prostate_biomarker_validation/model_workspace"
...
class Marker7SurvivalPairedRealInputTests(unittest.TestCase):
    ...
    def test_real_end_to_end_refits_both_endpoints_and_publishes_auditable_outputs(self):
        ...
        with tempfile.TemporaryDirectory() as temporary:
            ...
            frozen = pd.read_csv(ROOT / "resources/projects/prostate_biomarker_validation/model_workspace/stability_fold_assignments.csv")
            ...
            legacy_hierarchy = pd.read_csv(ROOT / "resources/projects/prostate_biomarker_validation/model_workspace/marker7_clinical_hierarchy_predictions.csv")
            ...
            legacy_nested = pd.read_csv(ROOT / "resources/projects/prostate_biomarker_validation/model_workspace/confounder_nested_predictions.csv")

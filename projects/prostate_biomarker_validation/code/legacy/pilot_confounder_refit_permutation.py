...
def main():
    ...
    summary_path = os.path.join(ROOT, "resources/projects/prostate_biomarker_validation/model_workspace", f"confounder_refit_permutation_{args.suffix}_summary.csv")
    null_path = os.path.join(ROOT, "resources/projects/prostate_biomarker_validation/model_workspace", f"confounder_refit_permutation_{args.suffix}_null.csv")

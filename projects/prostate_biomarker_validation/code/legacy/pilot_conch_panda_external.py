...
rho=+0.478 (p=0.0021) -- see resources/projects/prostate_biomarker_validation/model_workspace/pilot_conch_nadt_probe.py and memory
...
Run with the CONCH-only venv (long job -- embeds thousands of tiles):
    CUDA_VISIBLE_DEVICES=<free_gpu> HF_HOME=~/.cache/huggingface-jhkim \
        resources/projects/prostate_biomarker_validation/model_workspace/.venv-conch/bin/python resources/projects/prostate_biomarker_validation/model_workspace/pilot_conch_panda_external.py
"""
import os
...
OUT_DIR = os.path.join(ROOT, "resources/projects/prostate_biomarker_validation/model_workspace/panda_conch_cache")

...
| 10 | 보고·논문 | FM6 locked clean rerun과 six-axis evidence-state 원고 편입 완료; author-controlled metadata handoff 대기 | [`../reports/`](../reports/), [`paper workspace`](../paper/evidence-qualified-alignment-prostate-cancer/), [`design`](../docs/designs/2026-08-15-quantitative-foundation-model-validation-evidence-qualified-alignment-manuscript-design.md), [`plan`](../docs/plans/2026-08-15-quantitative-foundation-model-validation-evidence-qualified-alignment-manuscript-plan.md) | 고정 FM6 결과·hash, grade/phenotype·PTEN/AR·SPOP·recurrence 근거 상태와 원고 provenance 재현 완료; author·affiliation·funding·ethics·release metadata 확인 후 제출 패키지 전환 |

...
| 09 | H2 기능적 질병예측 검증 | whole-tissue internal 완료; site-heldout는 encoder-specific partial, LEOPARD external은 fail/inconclusive로 종결; strong H2 잠금 | [`FM6 internal pilot report`](../milestones/fm6_internal_development_pilot/outputs/fm6-tcga-internal-development-pilot-report.md), [`site-heldout report`](../milestones/fm6_site_heldout_functional_validation/outputs/fm6-site-heldout-functional-xai-report.md), [`LEOPARD report`](../milestones/fm6_external_functional_validation/outputs/fm6-leopard-external-functional-xai-report.md), [`tumor detector audit`](../milestones/fm6_tumor_region_detector_audit/outputs/fm6-tumor-region-detector-audit-report.md), [`../MILESTONES.md`](../MILESTONES.md) | Site: CONCH fail/Virchow pass; LEOPARD 508명/87 events에서 두 encoder fail/inconclusive; 재튜닝 금지·strong H2 금지 |

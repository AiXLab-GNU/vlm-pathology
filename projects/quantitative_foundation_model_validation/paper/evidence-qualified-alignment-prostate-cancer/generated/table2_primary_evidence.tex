...
\centering
\scriptsize
\caption{Complete primary recoverability and external morphology-transport estimates. Metrics and analysis units remain row-specific; unavailable intervals were not reconstructed.}
\label{tab:primary-evidence}

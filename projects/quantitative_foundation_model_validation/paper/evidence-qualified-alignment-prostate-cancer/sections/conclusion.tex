...
encoder-specific and the LEOPARD gate failed or remained inconclusive, so indispensable or
externally transported head use was not established.
...
indispensable use, and the failed external gate prevents promotion of the internal sensitivity
to transported functional use.

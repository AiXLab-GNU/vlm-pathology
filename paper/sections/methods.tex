...
\cite{nadt2021,panda2022,precise2026}; LEOPARD is described in the MIDL 2026 challenge
...
tumor-free visit before a later with-tumor visit. TCGA-CDR PFS and DFS used their named
cBioPortal comparator fields. Official TCGA-CDR PFI used the official PFI event and time
...
beyond grade, AR beyond grade, and marker 7 beyond grade or a fully adjusted clinical model.
...
Marker 7 was a post-hoc Cox risk score fitted in LEOPARD and applied without target-cohort
refitting to TCGA-PRAD. Its existing PCA dimension sweep served only as exploratory sensitivity
analysis. PCA-dimension selection was not nested within an outer evaluation,
...
Paired marker 7 outputs separately retained 2,000 valid and zero undefined replicates.
...
recoded as a negative outcome. Multiple imputation was not performed for the marker 7 paired
comparison.
...
from saved CSV source tables rather than transient objects. Source-table schema, analysis

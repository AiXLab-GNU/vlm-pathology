...
from paper.figures.fig2_transportable_signals import load_sources as _load_transport_sources
...
DEFAULT_SOURCE = ROOT / "paper/figure_data/fig2_transportable_signals.csv"

...
DEFAULT_AUC_SOURCE = ROOT / "models/marker7_td_auc_curve.csv"
DEFAULT_CALIBRATION_SOURCE = ROOT / "models/marker7_calibration_3y_5y.csv"
DEFAULT_METADATA_SOURCE = ROOT / "paper/figure_data/fig5_marker7_transfer.csv"

...
\caption{Target-by-axis qualification audit. Each row links an evidence state to the audited claim source and states what evidence would be required to change that state.}

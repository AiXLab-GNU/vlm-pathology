...
\caption{Target-by-axis qualification audit corresponding to Supplementary Figure S4. Each row links a target-specific evidence state to the audited claim source, states the current evidence, and specifies what evidence would be required to change that state. Not evaluated and not applicable are not negative results.}

...
SCRIPT = ROOT / "models/run_marker7_common_source_sensitivity.py"
...
class Marker7CommonUnitTests(unittest.TestCase):
    ...
    def test_r1_manifest_binds_frozen_config_input_hashes(self):
        with tempfile.TemporaryDirectory() as temporary_directory:
            ...
            source = root / "models/stability_runs/full/marker7_conch/source_meta_s0_mpp0.88.csv"
            ...
            manifest = pd.DataFrame(
                [{
                    "artifact_kind": "input",
                    "artifact_path": "models/stability_runs/full/marker7_conch/source_meta_s0_mpp0.88.csv",
            ...
            embedding = root / "models/stability_runs/full/marker7_conch/source_tile_embeddings_s0_mpp0.88.npy"
    ...
    def test_controller_probe_requires_exact_workspace_venv_path(self):
        ...
        wrong = {**probe, "executable": str(ROOT / "models/.venv-conch/bin/python")}
...
class Marker7CommonRealIntegrationTests(unittest.TestCase):
    ...
    def test_r1_contrast_and_r2_output_semantics_fail_closed(self):
        ...
        cells = pd.read_csv(ROOT / "models" / marker7_common.CELLS_NAME)
        deltas = pd.read_csv(ROOT / "models" / marker7_common.DELTAS_NAME)
        membership = pd.read_csv(ROOT / "models" / marker7_common.MEMBERSHIP_NAME)
...
class Marker7CommonRedGateTests(unittest.TestCase):
    def test_required_entry_point_exists(self):
        self.assertTrue(
            SCRIPT.exists(),
            "R2 RED: models/run_marker7_common_source_sensitivity.py is not implemented",
        )
